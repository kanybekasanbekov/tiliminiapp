...
var useTypographyCellComponents = () => {
  ...
  const Title3 = (0, import_react13.useCallback)((props) => {
    if (isIOS2) {
  ...
  const Description2 = (0, import_react13.useCallback)((props) => {
    if (isIOS2) {
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Blocks/Cell/Cell.js
var Cell = (0, import_react14.forwardRef)((_param, ref) => {
...
var AccordionSummary = (_param) => {
  ...
  const { expanded, labelId, contentId, onChange } = (0, import_react15.useContext)(AccordionContext);
...
var useAccordionId = (id) => {
  const randomId = (0, import_react16.useId)();
...
var Image = (_param) => {
  ...
  const needShowFallbackIcon = (failed || !hasSrc) && (0, import_react17.isValidElement)(fallbackIcon);
...
var Button = (0, import_react18.forwardRef)((_param, ref) => {
...
var CardContext = (0, import_react19.createContext)({
  type: "plain"
});
...
var CardCell = (_param) => {
  ...
  const cardContext = (0, import_react20.useContext)(CardContext);
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Blocks/Card/Card.js
var Card = (0, import_react21.forwardRef)((_param, ref) => {
...
var ButtonCell = (0, import_react22.forwardRef)((_param, ref) => {
  ...
  const platform2 = usePlatform();
  const Typography2 = platform2 === "ios" ? Text : Subheadline;
...
var IconButton = (0, import_react23.forwardRef)((_param, ref) => {
...
var InlineButtonsContext = (0, import_react24.createContext)({});
...
var InlineButtonsItem = (_param) => {
  ...
  const platform2 = usePlatform();
  const { mode: inheritMode } = (0, import_react25.useContext)(InlineButtonsContext);
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Blocks/InlineButtons/InlineButtons.js
var InlineButtons = (0, import_react26.forwardRef)((_param, ref) => {
      ...
      (0, import_jsx_runtime59.jsxs)("div", {
        ...
        children: [
          ...
          (0, import_jsx_runtime59.jsx)("div", {
            ...
            children: import_react27.Children.map(children, (child, index2) => (0, import_jsx_runtime59.jsxs)(import_jsx_runtime59.Fragment, {
              children: [
                child,
                index2 < import_react27.Children.count(children) - 1 && (0, import_jsx_runtime59.jsx)(Divider, {
...
var Timeline = (_param) => {
  ...
  return (0, import_jsx_runtime63.jsx)(Component, _object_spread_props(_object_spread({
    ...
    children: import_react28.Children.map(children, (child, index2) => {
      if ((0, import_react28.isValidElement)(child)) {
        return (0, import_react28.cloneElement)(child, _object_spread({
...
var RootRenderer = ({ children }) => {
  ...
  if (!(portalContainer === null || portalContainer === void 0 ? void 0 : portalContainer.current)) {
    return (0, import_react29.isValidElement)(children) ? children : null;
  }
...
var Snackbar = (_param) => {
  ...
  const platform2 = usePlatform();
  const [closing, setClosing] = (0, import_react30.useState)(false);
  const close = () => {
    setClosing(true);
    setTimeout(onClose, TRANSITION_FINISH_DURATION);
  };
  const closeTimeout = useTimeout(close, duration);
  (0, import_react30.useEffect)(() => closeTimeout.set(), [
    closeTimeout
  ]);
...
var Spoiler = (_param) => {
  ...
  const [isVisible, setIsVisible] = (0, import_react31.useState)(visible);
...
var VisuallyHidden = (0, import_react32.forwardRef)((_param, ref) => {
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Form/Checkbox/Checkbox.js
var Checkbox = (0, import_react33.forwardRef)((_param, ref) => {
...
var FormInput = (0, import_react34.forwardRef)((_param, ref) => {
...
var ColorInput = (_param) => {
  ...
  const platform2 = usePlatform();
  const [value, setValue] = (0, import_react35.useState)(valueProp || defaultValue || "#EFEFF4");
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Form/FileInput/FileInput.js
var FileInput = (0, import_react36.forwardRef)((_param, ref) => {
...
var Input = (0, import_react37.forwardRef)((_param, ref) => {
...
function useExternRef(...externRefs) {
  const stableRef = (0, import_react38.useRef)(null);
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Form/Multiselect/components/MultiselectBase/MultiselectBase.js
var MultiselectBase = (0, import_react39.forwardRef)((_param, ref) => {
  var {
    inputRef,
    className,
    // Option props
  ...
  return (
    ...
    (0, import_jsx_runtime84.jsxs)("div", {
      ...
      children: [
        chipsValue.map((option, index2) => (0, import_jsx_runtime84.jsx)(import_react39.Fragment, {
          children: renderChip({
...
var FloatingArrow = (0, import_react41.forwardRef)((_param, ref) => {
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Overlays/Popper/Popper.js
var Popper = (0, import_react43.forwardRef)((_param, ref) => {
  var {
  ...
  const [arrowRef, setArrowRef] = (0, import_react43.useState)(null);
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Form/Multiselect/components/MultiselectDropdown/MultiselectDropdown.js
var MultiselectDropdown = (0, import_react44.forwardRef)(({ dropdownAriaId, options, onMouseLeave, targetRef, addOptionFromInput, setFocusedOptionIndex, renderOption = renderOptionDefault, focusedOption, value, setOptionNode, setOpened, closeDropdownAfterSelect, addOption, focusedOptionIndex, clearInput }, ref) => {
  return (0, import_jsx_runtime91.jsx)(Popper, {
    ...
    children: options.map((option, index2) => {
      ...
      return (0, import_jsx_runtime91.jsx)(import_react44.Fragment, {
...
var getTextFromChildren = (children) => {
  if (!(children instanceof Array) && !(0, import_react45.isValidElement)(children)) {
    return childToString(children);
  }
  return import_react45.Children.toArray(children).reduce((text, child) => {
    let newText = "";
    const isValidElementResult = (0, import_react45.isValidElement)(child);
...
function useCustomEnsuredControl({ value, defaultValue, disabled, onChange: onChangeProp }) {
  ...
  const [localValue, setLocalValue] = (0, import_react46.useState)(defaultValue);
  const preservedControlledValueRef = (0, import_react46.useRef)();
  useEnhancedEffect(() => {
    preservedControlledValueRef.current = value;
  });
  const onChange = (0, import_react46.useCallback)((nextValue) => {
    if (disabled) {
      return;
    }
...
var useMultiselectInput = ({ disabled, value: valueProp, onChange, defaultValue = [], inputValue: inputValueProp = "", onInputChange }) => {
  ...
  const [inputValue, setInputValue] = (0, import_react47.useState)(inputValueProp);
  const toggleOption = (0, import_react47.useCallback)((nextValueProp, isNewValue) => {
  ...
  const clearInput = (0, import_react47.useCallback)(() => {
    simulateReactInput(inputRef.current, "");
  }, [
    inputRef
  ]);
  const addOption = (0, import_react47.useCallback)((newValue) => toggleOption(newValue, true), [
    toggleOption
  ]);
  const removeOption = (0, import_react47.useCallback)((newValue) => {
    toggleOption(newValue, false);
  }, [
    toggleOption
  ]);
  const addOptionFromInput = (0, import_react47.useCallback)((inputValueToAdd) => {
  ...
  const inputChange = (0, import_react47.useCallback)((event) => {
...
var useMultiselect = ({
  ...
  const [opened, setOpened] = (0, import_react48.useState)(false);
  const [options, setOptions] = (0, import_react48.useState)(() => opened ? transformOptions({
    value,
    inputValue,
    emptyText,
    creatable,
  ...
  const [focusedOptionIndex, setFocusedOptionIndex] = (0, import_react48.useState)(0);
  const [focusedOption, setFocusedOption] = (0, import_react48.useState)(null);
  const handleInputChange = (0, import_react48.useCallback)((event) => {
    onInputChange(event);
    if (!opened) {
      return;
    }
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Form/Multiselect/Multiselect.js
var Multiselect = (0, import_react49.forwardRef)((_param, ref) => {
  var {
    // FormInput options
    header,
    before,
  ...
  const dropdownAriaId = (0, import_react49.useId)();
  const dropdownScrollBoxRef = (0, import_react49.useRef)(null);
  const handleFocus = () => {
    setOpened(true);
  ...
  const optionsNodes = (0, import_react49.useRef)([]).current;
  ...
  const onDropdownMouseLeave = (0, import_react49.useCallback)(() => {
    setFocusedOptionIndex(null);
  }, [
    setFocusedOptionIndex
  ]);
  ...
  const handleClickOutside = (0, import_react49.useCallback)(() => {
    setOpened(false);
  }, [
    setOpened
  ]);
...
// node_modules/@telegram-apps/telegram-ui/dist/icons/36/face_id.js
var import_jsx_runtime99 = __toESM(require_jsx_runtime());
var Icon36FaceId = (_param) => {
  var restProps = _extends({}, _object_destructuring_empty(_param));
  return (0, import_jsx_runtime99.jsx)("svg", _object_spread_props(_object_spread({
    width: "36",
    height: "36",
    viewBox: "0 0 36 36",
    fill: "none",
    ...
    children: (0, import_jsx_runtime99.jsx)("path", {
...
// node_modules/@telegram-apps/telegram-ui/dist/icons/36/fingerprint.js
var import_jsx_runtime100 = __toESM(require_jsx_runtime());
var Icon36FingerPrint = (_param) => {
  var restProps = _extends({}, _object_destructuring_empty(_param));
  return (0, import_jsx_runtime100.jsxs)("svg", _object_spread_props(_object_spread({
    width: "36",
    height: "36",
    viewBox: "0 0 36 36",
    fill: "none",
    ...
    children: [
      (0, import_jsx_runtime100.jsx)("path", {
...
// node_modules/@telegram-apps/telegram-ui/dist/icons/36/scan_face.js
var import_jsx_runtime101 = __toESM(require_jsx_runtime());
var Icon36ScanFace = (_param) => {
  var restProps = _extends({}, _object_destructuring_empty(_param));
...
var ButtonTypography2 = (props) => {
  const platform2 = usePlatform();
  if (platform2 === "ios") {
    return (0, import_jsx_runtime102.jsx)(LargeTitle, _object_spread({}, props));
  }
  return (0, import_jsx_runtime102.jsx)(Title, _object_spread({}, props));
};
var PinInputButton = (_param) => {
  ...
  const platform2 = usePlatform();
  return (0, import_jsx_runtime102.jsx)(Tappable, _object_spread_props(_object_spread({
    Component: "button",
    className: classNames("tgui-6eaa561b38208c72", platform2 === "ios" && "tgui-3bea52c968cee224")
  }, restProps), {
    children: (0, import_jsx_runtime102.jsx)(ButtonTypography2, {
      children
    })
  }));
};
...
var PinInputCell = (0, import_react50.forwardRef)((_param, ref) => {
  ...
  return (0, import_jsx_runtime103.jsxs)("label", {
    ...
    children: [
      (0, import_jsx_runtime103.jsx)(VisuallyHidden, _object_spread({
        Component: "input",
        type: "number",
        maxLength: 1,
        className: "tgui-0bd147a2a35a8dd1"
      }, restProps)),
      isTyped && !isIOS2 && (0, import_jsx_runtime103.jsx)("div", {
...
var BiometricType;
(function(BiometricType2) {
  BiometricType2["FACEID"] = "faceid";
  BiometricType2["FINGERPRINT"] = "fingerprint";
})(BiometricType || (BiometricType = {}));
var BIOMETRIC_AUTH_BUTTON_VALUE = "BiometricAuth";
var DEFAULT_PINS = [
  1,
  2,
  3,
...
var getAvailablePins = (biometricType) => {
  const pins = [
    ...DEFAULT_PINS
  ];
  if (!biometricType) {
...
var usePinInput = ({ pinCount, value: valueProp = [], onChange, onBiometricAuth, biometricType = void 0 }) => {
  const PINS = getAvailablePins(biometricType);
  const inputRefs = (0, import_react51.useRef)([]).current;
  const [value, setValue] = useCustomEnsuredControl({
  ...
  const handleClickValue = (0, import_react51.useCallback)((enteredValue) => {
  ...
  const handleClickBackspace = (0, import_react51.useCallback)(() => {
    removeLastValue(value.length - 1);
  }, [
    value
  ]);
  const handleBiometricAuth = (0, import_react51.useCallback)(() => {
    if (onBiometricAuth) {
      onBiometricAuth();
    }
  }, [
  ...
  const handleButton = (0, import_react51.useCallback)((index2, button) => {
    const numButton = Number(button);
    if (!Number.isNaN(numButton) && PINS.includes(numButton)) {
      setValueByIndex(index2, numButton);
  ...
  const setInputRefByIndex = (0, import_react51.useCallback)((index2, ref) => {
    if (!ref) {
      return;
    }
    inputRefs[index2] = ref;
  }, []);
  const onElementClick = (0, import_react51.useCallback)((element) => {
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Form/PinInput/PinInput.js
var PIN_MIN_COUNT = 2;
var PinInput = (0, import_react52.forwardRef)((_param, ref) => {
  ...
  const getActionButtonComponent = (element, type) => {
    ...
    switch (type) {
      case BiometricType.FACEID:
        return platform2 === "ios" ? Icon36FaceId : Icon36ScanFace;
  ...
  return (0, import_jsx_runtime104.jsx)(RootRenderer, {
    children: (0, import_jsx_runtime104.jsxs)("section", _object_spread_props(_object_spread({
      ref,
      className: classNames("tgui-a641ca1e63331268", platform2 === "ios" && "tgui-bf64531d065e1bd9", className)
    }, restProps), {
      children: [
        (0, import_jsx_runtime104.jsxs)("header", {
          className: "tgui-a40b67b8ec9e3a49",
          children: [
            (0, import_jsx_runtime104.jsx)(Headline, {
            ...
            (0, import_jsx_runtime104.jsx)("div", {
              ...
              }).map((_, index2) => (0, import_jsx_runtime104.jsx)(PinInputCell, {
        ...
        (0, import_jsx_runtime104.jsx)("div", {
          ...
          children: createChunks(PINS, 3).map((rows) => (0, import_jsx_runtime104.jsx)("div", {
            className: classNames("tgui-49b69c407401f76c", biometricType === void 0 && "tgui-fa5069ea6f3c02e4"),
            children: rows.map((element) => {
              const ActionButtonComponent = getActionButtonComponent(element, biometricType);
              return (0, import_jsx_runtime104.jsx)(PinInputButton, {
                onClick: () => onElementClick(element),
                children: ActionButtonComponent ? (0, import_jsx_runtime104.jsx)(ActionButtonComponent, {
...
var IconRadio = (_param) => {
  var restProps = _extends({}, _object_destructuring_empty(_param));
  return (0, import_jsx_runtime105.jsx)("svg", _object_spread_props(_object_spread({
    width: "20",
    height: "20",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var IconRadioChecked = (_param) => {
  var restProps = _extends({}, _object_destructuring_empty(_param));
  return (0, import_jsx_runtime106.jsxs)("svg", _object_spread_props(_object_spread({
    width: "20",
    height: "20",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
    ...
    children: [
      (0, import_jsx_runtime106.jsx)("path", {
        fillRule: "evenodd",
        clipRule: "evenodd",
        d: "M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16Zm0 2a10 10 0 1 0 0-20 10 10 0 0 0 0 20Z",
        fill: "currentColor"
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Form/Radio/Radio.js
var Radio = (0, import_react53.forwardRef)((_param, ref) => {
  var { style, className, disabled } = _param, restProps = _object_without_properties(_param, [
    "style",
    "className",
    "disabled"
  ]);
  return (0, import_jsx_runtime107.jsxs)("label", {
    className: classNames("tgui-de477a8e3910f19f", disabled && "tgui-d5c5e7402bfd8c12", className),
    children: [
      (0, import_jsx_runtime107.jsx)(VisuallyHidden, _object_spread_props(_object_spread({}, restProps), {
        Component: "input",
        type: "radio",
      ...
      (0, import_jsx_runtime107.jsx)(IconRadio, {
        className: "tgui-bfcd091645843388",
        "aria-hidden": true
      }),
      (0, import_jsx_runtime107.jsx)(IconRadioChecked, {
...
var IconStar = (props) => (0, import_jsx_runtime108.jsx)("svg", _object_spread_props(_object_spread({
  width: "40",
  height: "40",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
var Rating = ({ precision = 1, max: max2 = 5, onChange, value: valueProp = 0, IconContainer: IconContainer2 = IconStar }) => {
  ...
  return (0, import_jsx_runtime109.jsxs)("label", {
    ...
    children: [
      (0, import_jsx_runtime109.jsx)(VisuallyHidden, {
        Component: "input",
        name: "rating",
        type: "radio",
        value: 0
      ...
      keys.map((key) => {
        ...
        return (0, import_jsx_runtime109.jsxs)("label", {
          ...
          children: [
            pickedElementWidth !== void 0 && (0, import_jsx_runtime109.jsx)(IconContainer2, {
              className: "tgui-f0faaa15f44569ba",
              style: {
                width: `${pickedElementWidth * 100}%`
              }
            }, "star-picked"),
            (0, import_jsx_runtime109.jsx)(IconContainer2, {}, "star"),
            elements.map((element) => (0, import_jsx_runtime109.jsx)("input", {
              type: "radio",
...
var Select = (0, import_react54.forwardRef)((_param, ref) => {
  ...
  const platform2 = usePlatform();
  const TypographyComponent = platform2 === "ios" ? Text : Subheadline;
  return (0, import_jsx_runtime110.jsxs)(FormInput, {
    header,
    before,
    status,
    className: classNames("tgui-919c5658483cae11", platform2 === "ios" && "tgui-5edcb8465ee11055", className),
    children: [
      (0, import_jsx_runtime110.jsx)(TypographyComponent, _object_spread({
        Component: "select",
        className: "tgui-a0742fd4c73756f7",
        multiple: false,
        ref
      }, restProps)),
      (0, import_jsx_runtime110.jsx)(Icon20ChevronDown, {
        "aria-hidden": true,
...
var IconSelectableBase = (_param) => {
  var restProps = _extends({}, _object_destructuring_empty(_param));
  return (0, import_jsx_runtime111.jsx)("svg", _object_spread_props(_object_spread({
    width: "20",
    height: "20",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, restProps), {
    children: (0, import_jsx_runtime111.jsx)("path", {
...
var IconSelectableIOS = (_param) => {
  var restProps = _extends({}, _object_destructuring_empty(_param));
  return (0, import_jsx_runtime112.jsx)("svg", _object_spread_props(_object_spread({
    width: "20",
    height: "20",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, restProps), {
    children: (0, import_jsx_runtime112.jsx)("path", {
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Form/Selectable/Selectable.js
var Selectable = (0, import_react55.forwardRef)((_param, ref) => {
  var { style, className, disabled } = _param, restProps = _object_without_properties(_param, [
    "style",
    "className",
    "disabled"
  ...
  return (0, import_jsx_runtime113.jsxs)("label", {
    ...
    children: [
      ...
      platform2 === "ios" && (0, import_jsx_runtime113.jsx)(IconSelectableIOS, {
        className: "tgui-ad96577f259c5732",
        "aria-hidden": true
      }),
      platform2 === "base" && (0, import_jsx_runtime113.jsx)(IconSelectableBase, {
        className: "tgui-ad96577f259c5732",
        "aria-hidden": true
      })
    ]
...
function useEventListener(event, _cb, _options) {
  const cbRef = (0, import_react56.useRef)(_cb);
  useEnhancedEffect(() => {
    cbRef.current = _cb;
  }, [
    _cb
  ]);
  const cb = (0, import_react56.useCallback)((e) => cbRef.current && cbRef.current(e), []);
  const detach = (0, import_react56.useRef)(() => {
  });
  ...
  const add = (0, import_react56.useCallback)((el) => {
    if (!canUseDOM) {
      return;
    }
    remove();
  ...
  (0, import_react56.useEffect)(() => remove, [
    remove
  ]);
...
var Touch = (_param) => {
  ...
  const events = (0, import_react57.useMemo)(getSupportedEvents, []);
  const didSlide = (0, import_react57.useRef)(false);
  const gesture = (0, import_react57.useRef)(null);
  ...
  const containerRef = (0, import_react57.useRef)();
  useEnhancedEffect(() => {
  ...
  return (0, import_jsx_runtime114.jsx)(Component, _object_spread_props(_object_spread({}, restProps), {
    onDragStart,
...
var SliderSteps = ({ steps }) => {
  const platform2 = usePlatform();
  return (0, import_jsx_runtime115.jsx)(import_jsx_runtime115.Fragment, {
    children: steps.map(({ isPassed, XCoordinate }) => (0, import_jsx_runtime115.jsx)("div", {
...
var SliderThumb = (0, import_react58.forwardRef)((_param, ref) => {
  ...
  const platform2 = usePlatform();
  return (0, import_jsx_runtime116.jsx)("span", _object_spread_props(_object_spread({
    className: classNames("tgui-83b7253102c6addc", platform2 === "ios" && "tgui-96f5864d281f94a8", className)
  }, restProps), {
    children: (0, import_jsx_runtime116.jsx)(VisuallyHidden, _object_spread_props(_object_spread({}, inputProps), {
      Component: "input",
      type: "range",
      ref,
...
var useSlider = (_param) => {
  ...
  const [localValue, setValue] = (0, import_react59.useState)(defaultValue);
  ...
  const gesture = (0, import_react59.useRef)({
    dragging: null,
    startX: 0,
    containerWidth: 0
  }).current;
  const thumbsContainerRef = (0, import_react59.useRef)(null);
  const thumbStartInputRef = (0, import_react59.useRef)(null);
  const thumbEndInputRef = (0, import_react59.useRef)(null);
...
var Slider = (_param) => {
  ...
  return (0, import_jsx_runtime117.jsxs)("div", {
    ...
    children: [
      hasReactNode(before) && (0, import_jsx_runtime117.jsx)("div", {
        className: "tgui-6598607160233201",
        children: before
      }),
      (0, import_jsx_runtime117.jsxs)(Touch, _object_spread_props(_object_spread({}, containerProps), {
        ...
        children: [
          (0, import_jsx_runtime117.jsx)("div", {
            ...
            children: steps !== void 0 && (0, import_jsx_runtime117.jsx)(SliderSteps, {
              steps
            })
          }),
          (0, import_jsx_runtime117.jsx)("div", {
          ...
          (0, import_jsx_runtime117.jsxs)("div", {
            ref: thumbsContainerRef,
            className: "tgui-7fe9f0fbc9771947",
            children: [
              (0, import_jsx_runtime117.jsx)(SliderThumb, {
                "data-type": "start",
              ...
              multiple && (0, import_jsx_runtime117.jsx)(SliderThumb, {
                "data-type": "end",
      ...
      hasReactNode(after) && (0, import_jsx_runtime117.jsx)("div", {
...
var Switch = (0, import_react60.forwardRef)((_param, ref) => {
  ...
  const platform2 = usePlatform();
  return (0, import_jsx_runtime118.jsxs)("label", {
    className: classNames("tgui-a1dc55b304d32032", platformStyles2[platform2], disabled && "tgui-57a00e000de7483d", className),
    children: [
      (0, import_jsx_runtime118.jsx)(VisuallyHidden, _object_spread_props(_object_spread({}, restProps), {
        Component: "input",
        type: "checkbox",
...
var Textarea = (0, import_react61.forwardRef)((_param, ref) => {
  ...
  const platform2 = usePlatform();
  const TypographyComponent = platform2 === "ios" ? Text : Subheadline;
  return (0, import_jsx_runtime119.jsx)(FormInput, {
    header,
    status,
    className: classNames("tgui-54ba5b4c7f1fd05a", platform2 === "ios" && "tgui-2453b62de8016bfa", className),
    children: (0, import_jsx_runtime119.jsx)(TypographyComponent, _object_spread({
      ref,
      Component: "textarea",
...
var TabbarItem = (_param) => {
  ...
  const platform2 = usePlatform();
  return (0, import_jsx_runtime121.jsxs)(Tappable, _object_spread_props(_object_spread({
    Component: "button",
    interactiveAnimation: "opacity",
    className: classNames("tgui-64cd0db020a9bacf", platform2 === "ios" && "tgui-ecbb746748ea4134", selected && "tgui-e6658d0b8927f95e", className)
  }, restProps), {
    children: [
      hasReactNode(children) && (0, import_jsx_runtime121.jsx)("div", {
        className: "tgui-44d48e11585af170",
        children
      }),
      hasReactNode(text) && (0, import_jsx_runtime121.jsx)(Caption, {
...
var Tabbar = (_param) => {
  ...
  const platform2 = usePlatform();
  return (0, import_jsx_runtime122.jsx)(FixedLayout, _object_spread_props(_object_spread({
...
var BreadCrumbsItem = (_param) => {
  ...
  return (0, import_jsx_runtime123.jsx)(Component, _object_spread_props(_object_spread({
    className: classNames("tgui-32fe6ce00169d72e", className)
  }, restProps), {
    children: (0, import_jsx_runtime123.jsx)(Subheadline, {
      level: "2",
      weight: "2",
      children
    })
...
var IconDot = (_param) => {
  var restProps = _extends({}, _object_destructuring_empty(_param));
  return (0, import_jsx_runtime124.jsx)("svg", _object_spread_props(_object_spread({
    width: "21",
    height: "20",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, restProps), {
    children: (0, import_jsx_runtime124.jsx)("circle", {
      cx: "10.5",
      cy: "10",
      r: "2",
      fill: "currentColor"
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Navigation/Breadcrumbs/Breadcrumbs.js
var Breadcrumbs = ({ divider = "dot", className, children }) => (0, import_jsx_runtime126.jsx)("div", {
  className: classNames("tgui-68fc52f1068b8e16", className),
  children: import_react62.Children.map(children, (child, index2) => (0, import_jsx_runtime126.jsxs)(import_jsx_runtime126.Fragment, {
    children: [
      child,
      index2 !== import_react62.Children.count(children) - 1 && (0, import_jsx_runtime126.jsxs)("div", {
        className: "tgui-0eddcd83377979c2",
        children: [
          divider === "dot" && (0, import_jsx_runtime126.jsx)(IconDot, {}),
          divider === "slash" && (0, import_jsx_runtime126.jsx)(IconSlash, {}),
          divider === "chevron" && (0, import_jsx_runtime126.jsx)(Icon16Chevron, {
...
var CompactPaginationItem = (_param) => {
  ...
  return (0, import_jsx_runtime127.jsx)("button", _object_spread_props(_object_spread({
    type: "button",
    role: "tab",
    "aria-selected": selected,
    className: classNames("tgui-747563e660315b07", selected && "tgui-6d14364fac453a65", className)
  }, restProps), {
    children: hasReactNode(children) ? (0, import_jsx_runtime127.jsx)(VisuallyHidden, {
      children
    }) : void 0
  }));
};
...
var Link = (_param) => {
  ...
  return (0, import_jsx_runtime129.jsx)("a", _object_spread_props(_object_spread({
...
var Icon24ChevronLeft = (_param) => {
  var restProps = _extends({}, _object_destructuring_empty(_param));
  return (0, import_jsx_runtime130.jsx)("svg", _object_spread_props(_object_spread({
    width: "24",
    height: "24",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, restProps), {
    children: (0, import_jsx_runtime130.jsx)("path", {
      fillRule: "evenodd",
      clipRule: "evenodd",
...
var Icon24ChevronRight = (_param) => {
  var restProps = _extends({}, _object_destructuring_empty(_param));
  return (0, import_jsx_runtime131.jsx)("svg", _object_spread_props(_object_spread({
    width: "24",
    height: "24",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var Pagination = (_param) => {
  ...
  const getPaginationChild = (item) => {
    switch (item.type) {
      case PaginationType.Previous:
        return (0, import_jsx_runtime132.jsx)(Icon24ChevronLeft, {
          className: "tgui-2636b28cb21c42cc"
        });
      case PaginationType.Next:
        return (0, import_jsx_runtime132.jsx)(Icon24ChevronRight, {
          className: "tgui-2636b28cb21c42cc"
        });
  ...
  return (0, import_jsx_runtime132.jsx)("div", _object_spread_props(_object_spread({
    role: "tablist",
    ...
    children: paginationItems.map((item) => {
      ...
      return (0, import_jsx_runtime132.jsx)(Headline, {
...
var SegmentedControlItem = (_param) => {
  ...
  const platform2 = usePlatform();
  return (0, import_jsx_runtime133.jsx)(Tappable, _object_spread_props(_object_spread({
    role: "tab",
    Component: "button",
    className: classNames("tgui-bbfb272d22eb23e8", platform2 === "ios" && "tgui-513fce1023cbbd63", className)
  }, restProps), {
    children: (0, import_jsx_runtime133.jsx)(Caption, {
      weight: selected ? "2" : "3",
      children
    })
  }));
...
var SegmentedControl = (_param) => {
  ...
  const platform2 = usePlatform();
  const childrenAsArray = import_react63.Children.toArray(children);
  const checkedIndex = childrenAsArray.findIndex((option) => {
    return (0, import_react63.isValidElement)(option) && option.props.selected;
  });
  const translateX = `translateX(${100 * checkedIndex}%)`;
  return (0, import_jsx_runtime134.jsx)("div", _object_spread_props(_object_spread({
    role: "tablist",
    className: classNames("tgui-71259e3311d7116e", platform2 === "ios" && "tgui-16c6b1986a48e2b5", className)
  }, restProps), {
    children: (0, import_jsx_runtime134.jsxs)("div", {
      className: "tgui-b0a9057ab5d33005",
      children: [
        checkedIndex > -1 && (0, import_jsx_runtime134.jsx)("div", {
          "aria-hidden": true,
...
var TabsItem = (_param) => {
  ...
  return (0, import_jsx_runtime135.jsx)(Tappable, _object_spread_props(_object_spread({
    role: "tab",
    Component: "button",
    className: classNames("tgui-96892ceed80c1bf3", selected && "tgui-44ea091aea23df33", className)
  }, restProps), {
    children: (0, import_jsx_runtime135.jsx)(Text, {
...
var TabsList = (_param) => {
  ...
  const childrenAsArray = import_react64.Children.toArray(children);
  const checkedIndex = childrenAsArray.findIndex((option) => {
    return (0, import_react64.isValidElement)(option) && option.props.selected;
  });
  const translateX = `translateX(${100 * checkedIndex}%)`;
  return (0, import_jsx_runtime136.jsxs)("div", _object_spread_props(_object_spread({
    role: "tablist",
    className: classNames("tgui-89d3925598b8fd68", className)
  }, restProps), {
    children: [
      checkedIndex > -1 && (0, import_jsx_runtime136.jsx)("div", {
        "aria-hidden": true,
...
function createContext22(rootComponentName, defaultContext) {
  ...
  const Provider = (props) => {
    ...
    return (0, import_jsx_runtime137.jsx)(Context.Provider, { value, children });
  };
...
// node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect = React8[" useInsertionEffect ".trim().toString()] || useLayoutEffect22;
...
function createSlot(ownerName) {
  ...
  const Slot22 = React9.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime138.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React9.isValidElement(newElement) ? React9.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime138.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
...
function createSlottable(ownerName) {
  const Slottable2 = ({ children }) => {
    return (0, import_jsx_runtime138.jsx)(import_jsx_runtime138.Fragment, { children });
  };
...
var Primitive = NODES.reduce((primitive, node) => {
  ...
  const Node2 = React10.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime139.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
...
var DismissableLayerBranch = React13.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime140.jsx)(Primitive.div, { ...props, ref: composedRefs });
});
...
var FocusScope = React14.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime141.jsx)(Primitive.div, { tabIndex: -1, ...scopeProps, ref: composedRefs, onKeyDown: handleKeyDown });
});
...
var Portal = React15.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom5.default.createPortal((0, import_jsx_runtime142.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime143.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React29.Children.map(children, (child) => (0, import_jsx_runtime143.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime143.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlay = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.modal ? (0, import_jsx_runtime143.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime143.jsx)(DialogOverlayImpl, { ...overlayProps, ref: forwardedRef }) }) : null;
  }
);
...
var DialogOverlayImpl = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      (0, import_jsx_runtime143.jsx)(Combination_default, { as: Slot2, allowPinchZoom: true, shards: [context.contentRef], children: (0, import_jsx_runtime143.jsx)(
        Primitive.div,
        {
          "data-state": getState(context.open),
          ...overlayProps,
...
var DialogContent = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime143.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime143.jsx)(DialogContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime143.jsx)(DialogContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
...
var DialogContentImpl = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime143.jsxs)(import_jsx_runtime143.Fragment, { children: [
      ...
      (0, import_jsx_runtime143.jsxs)(import_jsx_runtime143.Fragment, { children: [
        (0, import_jsx_runtime143.jsx)(TitleWarning, { titleId: context.titleId }),
        (0, import_jsx_runtime143.jsx)(DescriptionWarning, { contentRef, descriptionId: context.descriptionId })
      ] })
    ] });
  }
);
...
var DialogTitle = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime143.jsx)(Primitive.h2, { id: context.titleId, ...titleProps, ref: forwardedRef });
  }
);
...
var DialogDescription = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime143.jsx)(Primitive.p, { id: context.descriptionId, ...descriptionProps, ref: forwardedRef });
  }
);
...
var DrawerContext = import_react68.default.createContext({
  drawerRef: {
    current: null
  },
  overlayRef: {
...
var useDrawerContext = () => import_react68.default.useContext(DrawerContext);
...
var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? import_react68.useLayoutEffect : import_react68.useEffect;
...
function usePositionFixed({ isOpen, modal, nested, hasBeenOpened, preventScrollRestoration }) {
  const [activeUrl, setActiveUrl] = import_react68.default.useState(typeof window !== "undefined" ? window.location.href : "");
  const scrollPos = import_react68.default.useRef(0);
  const setPositionFixed = import_react68.default.useCallback(() => {
  ...
  const restorePositionSetting = import_react68.default.useCallback(() => {
...
function useCallbackRef3(callback) {
  const callbackRef = import_react68.default.useRef(callback);
  import_react68.default.useEffect(() => {
    callbackRef.current = callback;
  });
  return import_react68.default.useMemo(() => (...args) => callbackRef.current == null ? void 0 : callbackRef.current.call(callbackRef, ...args), []);
}
function useUncontrolledState2({ defaultProp, onChange }) {
  const uncontrolledState = import_react68.default.useState(defaultProp);
  const [value] = uncontrolledState;
  const prevValueRef = import_react68.default.useRef(value);
...
function useControllableState2({ prop, defaultProp, onChange = () => {
  ...
  const value = isControlled ? prop : uncontrolledProp;
  const handleChange = useCallbackRef3(onChange);
  const setValue = import_react68.default.useCallback((nextValue) => {
    if (isControlled) {
...
function useSnapPoints({ activeSnapPointProp, setActiveSnapPointProp, snapPoints, drawerRef, overlayRef, fadeFromIndex, onSnapPointChange, direction = "bottom" }) {
  ...
  const isLastSnapPoint = import_react68.default.useMemo(() => activeSnapPoint === (snapPoints == null ? void 0 : snapPoints[snapPoints.length - 1]) || null, [
    snapPoints,
    activeSnapPoint
  ]);
  const shouldFade = snapPoints && snapPoints.length > 0 && (fadeFromIndex || fadeFromIndex === 0) && !Number.isNaN(fadeFromIndex) && snapPoints[fadeFromIndex] === activeSnapPoint || !snapPoints;
  const activeSnapPointIndex = import_react68.default.useMemo(() => snapPoints == null ? void 0 : snapPoints.findIndex((snapPoint) => snapPoint === activeSnapPoint), [
    snapPoints,
    activeSnapPoint
  ]);
  const snapPointsOffset = import_react68.default.useMemo(() => {
    var _snapPoints_map;
  ...
  const activeSnapPointOffset = import_react68.default.useMemo(() => activeSnapPointIndex !== null ? snapPointsOffset == null ? void 0 : snapPointsOffset[activeSnapPointIndex] : null, [
    snapPointsOffset,
    activeSnapPointIndex
  ]);
  const snapToPoint = import_react68.default.useCallback((dimension) => {
...
function Root2({ open: openProp, onOpenChange, children, shouldScaleBackground, onDrag: onDragProp, onRelease: onReleaseProp, snapPoints, nested = false, closeThreshold = CLOSE_THRESHOLD, scrollLockTimeout = SCROLL_LOCK_TIMEOUT, dismissible = true, fadeFromIndex = snapPoints && snapPoints.length - 1, activeSnapPoint: activeSnapPointProp, setActiveSnapPoint: setActiveSnapPointProp, fixed, modal = true, onClose, direction = "bottom", preventScrollRestoration = true, disablePreventScroll = false }) {
  ...
  const [isOpen = false, setIsOpen] = import_react68.default.useState(false);
  const [hasBeenOpened, setHasBeenOpened] = import_react68.default.useState(false);
  const [visible, setVisible] = import_react68.default.useState(false);
  const [mounted, setMounted] = import_react68.default.useState(false);
  const [isDragging, setIsDragging] = import_react68.default.useState(false);
  const [justReleased, setJustReleased] = import_react68.default.useState(false);
  const overlayRef = import_react68.default.useRef(null);
  const openTime = import_react68.default.useRef(null);
  const dragStartTime = import_react68.default.useRef(null);
  const dragEndTime = import_react68.default.useRef(null);
  const lastTimeDragPrevented = import_react68.default.useRef(null);
  const isAllowedToDrag = import_react68.default.useRef(false);
  const nestedOpenChangeTimer = import_react68.default.useRef(null);
  const pointerStart = import_react68.default.useRef(0);
  const keyboardIsOpen = import_react68.default.useRef(false);
  const previousDiffFromInitial = import_react68.default.useRef(0);
  const drawerRef = import_react68.default.useRef(null);
  const drawerHeightRef = import_react68.default.useRef(((_drawerRef_current = drawerRef.current) == null ? void 0 : _drawerRef_current.getBoundingClientRect().height) || 0);
  const initialDrawerHeight = import_react68.default.useRef(0);
  const onSnapPointChange = import_react68.default.useCallback((activeSnapPointIndex2) => {
  ...
  return import_react68.default.createElement(Root, {
    modal,
    onOpenChange: (o) => {
      if (openProp !== void 0) {
    ...
    open: isOpen
  }, import_react68.default.createElement(DrawerContext.Provider, {
    value: {
      visible,
      activeSnapPoint,
      snapPoints,
...
var Overlay2 = import_react68.default.forwardRef(function({ children, ...rest }, ref) {
  ...
  return import_react68.default.createElement(Overlay, {
    onMouseUp: onRelease,
    ref: composedRef,
...
var Content2 = import_react68.default.forwardRef(function({ onOpenAutoFocus, onPointerDownOutside, onAnimationEnd, style, ...rest }, ref) {
  ...
  const pointerStartRef = import_react68.default.useRef(null);
  import_react68.default.useEffect(() => {
    setVisible(true);
  }, []);
  ...
  return import_react68.default.createElement(Content, {
    "vaul-drawer": "",
...
function NestedRoot({ onDrag, onOpenChange, ...rest }) {
  ...
  return import_react68.default.createElement(Root2, {
    nested: true,
    onClose: () => {
...
var ModalClose = (props) => (0, import_jsx_runtime144.jsx)(Drawer.Close, _object_spread({
  asChild: true
}, props));
...
var ModalHeader = (0, import_react69.forwardRef)((_param, ref) => {
  ...
  const platform2 = usePlatform();
  return (0, import_jsx_runtime145.jsxs)("header", _object_spread_props(_object_spread({
    ref,
    ...
    children: [
      ...
      platform2 === "ios" && (0, import_jsx_runtime145.jsx)(Text, {
        weight: "2",
...
var ModalOverlay = (0, import_react70.forwardRef)((_param, ref) => {
  var { className } = _param, props = _object_without_properties(_param, [
    "className"
  ]);
  const context = useAppRootContext();
  const [r, g, b] = (0, import_react70.useMemo)(() => {
  ...
  return (0, import_jsx_runtime146.jsx)(Drawer.Overlay, _object_spread({
    ref,
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Overlays/Modal/Modal.js
var Modal = (0, import_react71.forwardRef)((_param, ref) => {
  var { overlayComponent = (0, import_jsx_runtime147.jsx)(ModalOverlay, {}), open, onOpenChange, header, className, children, nested, trigger, closeThreshold, scrollLockTimeout, snapPoints, fadeFromIndex, modal, preventScrollRestoration, dismissible } = _param, restProps = _object_without_properties(_param, [
    "overlayComponent",
    "open",
    "onOpenChange",
    "header",
  ...
  const [portal, setPortal] = (0, import_react71.useState)((_container_portalContainer = container.portalContainer) === null || _container_portalContainer === void 0 ? void 0 : _container_portalContainer.current);
  ...
  return (0, import_jsx_runtime147.jsxs)(Component, {
    open,
    onOpenChange,
    closeThreshold,
    scrollLockTimeout,
    ...
    dismissible,
    children: [
      trigger && (0, import_jsx_runtime147.jsx)(Drawer.Trigger, {
        asChild: true,
        children: trigger
      }),
      (0, import_jsx_runtime147.jsxs)(Drawer.Portal, {
        container: portal,
        children: [
          overlayComponent,
          (0, import_jsx_runtime147.jsxs)(Drawer.Content, _object_spread_props(_object_spread({
            ref,
            className: classNames("tgui-cc76354712c6e8d9", className)
          }, restProps), {
            children: [
              header,
              (0, import_jsx_runtime147.jsx)("div", {
...
var Tooltip = (_param) => {
  ...
  return (0, import_jsx_runtime148.jsx)(Popper, _object_spread_props(_object_spread({
    withArrow: true,
    ...
    children: (0, import_jsx_runtime148.jsx)(Caption, {
      level: "1",
      children
    })
  }));
...
var useAppearance = (appearanceProp) => {
  const { appearance: contextAppearance } = (0, import_react72.useContext)(AppRootContext);
  const [appearance, setAppearance] = (0, import_react72.useState)(appearanceProp || contextAppearance || getInitialAppearance());
  const handleThemeChange = (0, import_react72.useCallback)(() => {
    const telegramData = getTelegramData();
    if (!telegramData) {
      return;
    }
...
var usePlatform2 = (platform2) => {
  ...
  const appContext = (0, import_react73.useContext)(AppRootContext);
...
var usePortalContainer = (portalContainer) => {
  ...
  const appContext = (0, import_react74.useContext)(AppRootContext);
  if (appContext.isRendered && appContext.portalContainer !== void 0) {
    return appContext.portalContainer;
  }
  return (0, import_react74.useRef)(null);
};

// node_modules/@telegram-apps/telegram-ui/dist/components/Service/AppRoot/AppRoot.js
var AppRoot = (0, import_react75.forwardRef)((_param, ref) => {
  ...
  return (0, import_jsx_runtime149.jsx)("div", _object_spread_props(_object_spread({
    ...
    children: (0, import_jsx_runtime149.jsx)(AppRootContext.Provider, {
      value: contextValue,
      children
    })
  }));
